...
public class ImageTest {
    ...
    private int imageWidth = 2400;  //图片的宽度
    private int imageHeight = 3000; //图片的高度
    //生成图片文件
    ...
    public void test(String name,String url){
        ...
        //填充区域并确定区域大小位置
        title.fillRect(0, 0, imageWidth, 3000);
        //设置字体颜色，先设置颜色，再填充内容
        title.setColor(Color.darkGray);
        //设置字体
        Font titleFont = new Font("宋体", Font.BOLD, 60);
        title.setFont(titleFont);
        title.drawString(name, 100, (3000)/2+5);
        createImage("F:\\a.jpg");

    }
    public static void main(String[] args) {
        ImageTest cg = new ImageTest();
        try {
           // cg.graphicsGeneration("21123111111121321312", "1", "12", "F:\\nginx-1.12.2\\QQ截图20201126172403.jpg");
            cg.test("七二五五五五五五","F:\\\\nginx-1.12.2\\\\QQ截图20201126172403.jpg");
        } catch (Exception e) {
            e.printStackTrace();
        }
